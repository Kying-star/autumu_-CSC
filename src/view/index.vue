 ...
 * @LastEditTime: 2020-11-30 18:33:22
      ...
      <div class="content">
        ...
        <div class="lost-cxt">
          ...
          <div class="lost-list">
            <div
              class="cards"
              v-for="itme in showList"
              :key="itme.id"
            >
              <el-card :body-style="{ padding: '0px' }">
                <img
                  :src="require('../assets/image/mock/mock.png')"
                  class="image"
                >
                <div style="padding: 14px;">
                  <span>{{itme.tag}}</span>
                  <div class="bottom clearfix flex-box">
                    <time class="time2">{{itme.time}}</time>
                    <el-popover
                      placement="bottom"
                      title="详情"
                      width="200"
                      ...
                      :content="itme.detail"
                    >
                      <el-button slot="reference">了解详情</el-button>
                    </el-popover>
                  </div>
                </div>
              </el-card>
...
export default {
  ...
  methods: {
    ...
    changeTag() {
      ...
      this.showList = this.list.filter((e) => {
        console.log(e);
  ...
  created() {
    // console.log(this.$store.state.lostList);
