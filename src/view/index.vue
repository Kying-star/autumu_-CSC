 ...
 * @LastEditTime: 2020-11-29 03:00:34
    ...
    <div class="splider">
      ...
      <el-collapse accordion>
        <el-collapse-item >
          ...
          <div class="tip1">失物招领</div>
          <div class="tip1" @click="turn">寻物启示</div>
        </el-collapse-item>
                <el-collapse-item>
          <template slot="title">
            <i class="person"></i>个人
          </template>
            <div class="tip1">我的帖子</div>
            <div class="tip1" @click="turn">浏览历史</div>
            <div class="tip1">我的关注</div>          
        </el-collapse-item>
      </el-collapse>
    </div>
    <div class="inner">
